...
//                                                      Fixed, Good
 ...
 //console.log (canWeDeliver(deliveryAreaZipCodes, 85299))
...
//CODE HERE
const discount = (obj, searchValue, newValue) => {
     obj[0].title = obj[0].title.replace(searchValue, newValue);
     return obj;
//                                              Fixed, Good
}
console.log(discount(deals, "15%", "10%"))
...
//CODE HERE
const familyDeal = (obj, searchValue, newValue) => {
    obj[1].desc = obj[1].desc.trim().replace(searchValue, newValue);
    return obj;
}
//                                          good
console.log(familyDeal(deals, "March", "April"))
